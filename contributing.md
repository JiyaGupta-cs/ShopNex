...
<h3 align="center">Welcome to my ShopNex! 😍<br> We appreciate your interest in contributing.😊 <br>This guide will help you get started with the project and make your first contribution.</h3>
...
```css
git remote add upstream https://github.com/JiyaGupta-cs/Shopnex.git
```
...
1. Please follow our project's [Code of Conduct](https://github.com/JiyaGupta-cs/ShopNex/blob/master/.github/CODE_OF_CONDUCT.md) while contributing.
...
<p align="center">
  You can refer to the following articles on the basics of Git and GitHub and also contact the Project Mentors, in case you are stuck: <br>
